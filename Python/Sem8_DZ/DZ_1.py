...
def read_file_to_list(file_name):
    # sourcery skip: for-append-to-extend, list-comprehension, use-file-iterator
    with open(file_name, 'r', encoding='utf-8') as file:
        contact_list = []
...
def find_number(contact_list):
    # sourcery skip: for-append-to-extend, list-comprehension, simplify-len-comparison, swap-if-else-branches, use-named-expression
...
def search_to_modify(contact_list: list):  # sourcery skip: for-append-to-extend, list-comprehension
    search_field, search_value = search_parameters()
    search_result = []
    for contact in contact_list:
